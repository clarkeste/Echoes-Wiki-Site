...
Any Item that is thrown gains the [[Limited Ammo (Passive) (Quality)|Limited Ammo]] 1 [[Qualities|Quality]].

Usually, Thrown Weapons—even if they are Spears or [[Dagger|Daggers]]—use the [[Ranged]] [[Skills|Skill]]. However, if the one throwing uses a [[Sacred Points|Sacred Point]], they may instead use the Skill associated with that Weapon. For instance, a [[Knight's Halberd]] may be thrown with [[Melee-Heavy]], or a Dagger with [[Melee-Light]].