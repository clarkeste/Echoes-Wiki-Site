...
When activated on a successful [[Attack|Attack Spell]], the target is [[Staggered]] for a number of rounds equal to the weapon's Concussive rating. A Staggered target loses their [[Actions|Action]] and may not take any further Actions until the [[Status Effects|effect]] is cleared.
