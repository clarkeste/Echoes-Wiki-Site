...
In a successful [[Attack|Attack Spell]], may spend 2 [[Advantage|Advantages]] to use Burn on a target. A target afflicted with Burn continues to suffer the weapon's base [[Damage]] each Round for a number of Rounds equal to the Spell’s Burn rating. Damage is applied at the start of each of the target's turns.
