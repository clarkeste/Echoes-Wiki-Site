...
### Making the Check
Creating a Potion requires Hours of [[Downtime|Downtime]] equal to half of the Alchemy Points spent on it, rounding down. [[Success]] or [[Threat|Threat]] may speed up or slow down the process respectively, by two hours per Success. Once that Downtime is up, it's time to make the [[Skill Checks|Check]].

For every six Alchemy Points spent on creating a weapon, add a [[Difficulty Dice|Difficulty Die]] to the [[Medicine]] Check, with below 6 having no Difficulty Dice, 6-12 having one, etc. 

Attempting to make a Potion faster, using damaged or subpar equipment, or working off of faulty documents, will add Setbacks; likewise, creating a particularly unstable Potion—or doing so in unsafe circumstances—and or making one that needs a truly delicate touch will result in [[Challenge Dice|Challenge Dice]].
...
When crafting an item, may use Advantage to add more Modifiers; each Advantage counts as an Alchemy Point, a Triumph as five. Threat may add [[Modifiers#Drawbacks|Drawback]]. Modifiers and Drawbacks added like this are maintained without additional Alchemy Point cost if turned into a Template.

If the Medicine or Culinary check is not successful and generates no [[Success|Successes]], then the creator either creates a ruined and unusable Potion, or one far below the specifications due to an error in the process. The process may be attempted again, but will cost the same Downtime it first took. When a Medicine or Culinary Check to [[Charm of Greater Anti-Force]]a Potion fails, it can be rerolled immediately once using a [[Sacred Points|Sacred Point]].

#### Templates
Once a Potion or Meal is made, you may make a Template from it by making an [[Operating|Operating]] check. If you made the Potion, it is a [[Difficulty|Hard]] (3p) Check; if you did not, it is a [[Difficulty|Daunting]] (4p) Check. It takes 12 Hours, generally, to make a Template. 

This makes the brewing available for anyone else who attempts to make the Potion, or you in the future, and lessens the difficulty and Alchemy Point cost if it is remade exactly. It reduces the Difficulty by 1, the Alchemy Points by 4, and the Downtime by 4 Hours to a minimum of 1 Hour; additional Successes will decrease the Alchemy Points by 1, while Triumphs and Advantage might decrease the Difficulty further, add [[Boost Dice|Boosts]], or decrease the [[Downtime]] (2 [[Advantage]] per Hour). You may even find Templates for existing Potions and Meals on your journey! If you’re having trouble doing the Operating check, recruiting professional help could lower the difficulty to [[Difficulty|Average]] (2p) or even [[Difficulty|Easy]] (1p).
