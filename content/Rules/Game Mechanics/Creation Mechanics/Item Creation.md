...
For every six Crafting Points spent on creating a weapon, add a [[Difficulty Dice|Difficulty Die]] to the Craftsmanship check, with below 6 having no Difficulty Dice, 6-12 having one, etc.
