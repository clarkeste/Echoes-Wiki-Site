...
In Mass Combat, the Commander or Leader of the allied forces, almost always a PC, controls these Units, often multiple in a turn. They can move an amount of Units per turn equal to their ranks in [[Leadership]].
...
Only an amount of Units equal to the Battle Commander’s ranks in [[Leadership]] can be moved in a single Mass Combat turn.
...
## Units
Units are the core of Mass Combat, and the pieces on the board that determine if ground is held or captured. There are four types of Units.
### Unit Types
#### Infantry
...
#### Attack
[[Attack Check|Attack]] another Unit. If this is a Melee Attack, success will cause the attacking Unit to enter the space previously held by the defender. The defending Unit will then suffer [[Damage]] equal to the Damage stat of the attacking Unit, and fall back to a position.

The [[Dice Pool]] a Unit uses to attack is determined by the [[Skills|Skill]] of the overall Battle Commander—in the case of the allied side, almost always a [[PC|PC]]. There are up to five Skills that can be used as the positive Dice Pool—however, each one can only be used once on any given turn. These Skills are:
...
[[Difficulty]] is always [[Difficulty|Average]] (2p) Difficulty. Modifiers, of course, still apply, such as [[Sacred Points|Sacred Points]] expenditure, and Cover.
...
#### Reorganize
Reorganize to heal [[Strain]] when needed. When Reorganize is used, Units heal Strain equal to 2 + the amount of adjacent friendly Units.
#### Ability
...
### Abilities
Here are a few examples of Abilities that various Units can have, that provide strategic bonuses or considerations.
...
#### Keep Them Busy
Given to Skirmisher-type [[Mass Combat#Units|Units]]. Requires an [[Mass Combat#Actions|Action]] to activate. Both Units suffer 2 [[Damage]] and the targeted Unit is unable to act next turn.
#### Insurgent
...
#### Mindless
A [[Mass Combat#Units|Unit]] with this Ability follows orders without hesitation. They must be annihilated to be defeated. They are immune to Fear checks. They can be annihilated if their Strain goes over twice their Strain Threshold, or if two Triumphs are generated in an Attack.
#### Stand Your Ground!
...
#### Will and Resolve
This [[Mass Combat#Units|Unit]] is strong-willed, and can reorganize itself. It heals 2 [[Strain]] at the end of every turn it ends while over half its [[Strain Threshold]]. Additionally, fear-related effects do not affect them.
#### Defender
[[Mass Combat#Units|Units]] in a position/hex adjacent to an Allied Unit with the Defender [[Mass Combat#Ability|Ability]] add a [[Setback Dice|Setback Die]] to all [[Mass Combat#Attack|Attacks]] targeting them. This represents a Unit protecting Allies around them.
#### Suppressive Fire
When this [[Mass Combat#Units|Unit]] attacks another Unit, it can spend 2 [[Advantage|Advantages]] to prevent a target from acting on the its turn.
#### Mounted
...
#### Royal Guard
The cream of the crop, the most elite units of the Royalist Army. These [[Mass Combat#Units|Units]] are incredibly powerful, in the right positions.

[[Strain Threshold|Strain Threshold]]: 13
[[Defense]]: 2
[[Damage|Damage]]: 4
...
Once the leader of the army chooses to end their turn, or they have moved all the Units they could on their turn, the allied turn ends. Then, the [[Mass Combat#4 Enemy Turn|enemy turn]] begins.
...
If a Unit has no viable place to retreat (ie, all valid hexes are already occupied) then they suffer double [[Damage]] from the [[Mass Combat#Attack|Attack]] that displaced them, and they become un-Deployed and are entered ‘into reserve’. For them to enter the battlefield again, they must be re-Deployed.
