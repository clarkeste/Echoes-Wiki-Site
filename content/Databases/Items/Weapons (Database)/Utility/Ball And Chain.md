...
Soak:
Defense:
Special Effect: May spend 2 [[Advantage]] on an [[Attack Check]] to deal [[Damage#Base Damage|Base Damage]] to every enemy between the target and the [[Character]] with the Ball and Chain.
Price: 42000
Unique: false
Unlisted: false
Is Armor: false
