...
Soak:
Defense:
Special Effect: May lift up a single extremely heavy [[Items|Item]] of [[Encumbrance]] 20 or lower. If wearing the Steel Gauntlets while using another [[Weapons|Weapon]], add a [[Setback Dice]] to all rolls using that Weapon.
Price: 4500
Restricted: false
Unique: false
Unlisted: false
...
Special: May lift up a single extremely heavy [[Items|Item]] of [[Encumbrance]] 20 or lower. If wearing the Steel Gauntlets while using another [[Weapons|Weapon]], add a [[Setback Dice]] to all rolls using that Weapon.

Price: 4500 [[Rupees|Rupees]]
